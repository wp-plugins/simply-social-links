...
4. TODO: Int 'Options' tab configure the plugin
...
4. TODO: Na Aba de opções configure o plugin


== Frequently Asked Questions ==

= PT-BR =
1. E se eu preencher um link incorreto?
 R: Vai ficar incorreto. Não existe ainda um validador.

2. Possibilidade de incluir outras redes sociais?
