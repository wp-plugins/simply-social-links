<?php
function _walk_bookmarks_ssl ($bookmarks, $args = '' ) {
	$defaults = array(
	...
	foreach ( (array) $bookmarks as $bookmark ) {
		...
		$output = apply_filters('link_after', $output, $bookmark);
	...
	return $output . "<!-- rsrsrsr -->";
}



function wp_list_bookmarks_ssl($args = '') {
	$defaults = array(
	...
	if ( $categorize ) {
		...
		foreach ( (array) $cats as $cat ) {
			...
			$output .= _walk_bookmarks_ssl($bookmarks, $r);
			$output .= "\n\t</ul>\n$category_after\n";
		}
	} else {
